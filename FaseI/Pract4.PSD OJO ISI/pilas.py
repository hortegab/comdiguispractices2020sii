...
class pilas(gr.top_block, Qt.QWidget):
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.blocks_multiply_const_vxx_0_0.set_k(numpy.full(self.N,1./self.samp_rate))
        self.qtgui_freq_sink_x_0.set_frequency_range(0, self.samp_rate)
        self.qtgui_time_sink_x_0.set_samp_rate(self.samp_rate)
        self.qtgui_vector_sink_f_0.set_x_axis(-self.samp_rate/2, (self.samp_rate-1)/self.N)
    ...
    def set_N(self, N):
        self.N = N
        self.set_Fresolucion(2*self.Fmax/self.N)
        self.blocks_multiply_const_vxx_0_0.set_k(numpy.full(self.N,1./self.samp_rate))
        self.qtgui_vector_sink_f_0.set_x_axis(-self.samp_rate/2, (self.samp_rate-1)/self.N)
    ...
    def set_PSDmax(self, PSDmax):
        self.PSDmax = PSDmax
        self.qtgui_vector_sink_f_0.set_y_axis(0., self.PSDmax)

    def get_Fresolucion(self):
        return self.Fresolucion

    def set_Fresolucion(self, Fresolucion):
        self.Fresolucion = Fresolucion
...
def main(top_block_cls=pilas, options=None):
